          ...
          <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              {pendingUsers.length > 0 && (
                <span className="bg-rose-600 text-[9px] font-black text-white leading-none px-1.5 py-0.5 rounded-full animate-bounce">
                  {pendingUsers.length}
                </span>
              )}
            </button>
        ...
        <div className="p-6 bg-slate-50/30">
          {activeTab === 'agents' && (
            <UserManagementTable 
              ...
              role={userProfile.role} 
              tabType="agents" 
              onAssignTrainer={onAssignTrainerToAgent}
            />
          )}
          {activeTab === 'trainers' && (
            <UserManagementTable 
